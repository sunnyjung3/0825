...
public class ArticleController {
		...
		while(true) {
			...
			if(cmd2.equals("back")) {
				...
				if(App.loginedMember == null) {
					...
					System.out.println("좋아요 또는 싫어요를 선책해주세요.( like : 좋아요, hate : 싫어요));");
	...
	void printArticle(Article article) {
		...
		System.out.println("좋아요 : " + article.getHit());
		System.out.println("싫어요 : " + article.getHit());
	...
	void getCountOfLikesByArticleId(int articleId) {
		int count = 0;
	...
	int getCountOfHatesByArticleId(int articleId) {
